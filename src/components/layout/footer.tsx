const Footer = () => {
  return (
    <>
      <div className=" bg-amber-50 w-full px-20 py-20 mx-auto h-auto grid md:grid-cols-9">
        <div className="grid xl:gap-50  sm:grid-cols-6 col-span-9 sm:col-span-6">
        ...
        <div className="col-span-9 md:col-span-3 flex justify-center items-center md:block">
          <div className="h-[200px] mt-10 md:mt-0">
            <h3 className="text-[22px] text-center md:text-left p-0 m-0">
              Join Our Newsletter
            </h3>

            <div className="mt-10 bg-[#13124F] rounded-3xl flex justify-between">
              <input
                className="w-[35%] lg:w-[32%] ml-5 bg-transparent outline-none text-sm lg:text-base"
                type="text"
                placeholder="Enter Email"
              />
              <button className="w-[50%] text-white text-[12px] lg:text-base px-[40px] py-[15px] bg-[#9090DB] rounded-[83px] hover:bg-[#7777c8] hover:text-black hover:ease-in-out">
                SUBMIT
              </button>
            </div>
          </div>
